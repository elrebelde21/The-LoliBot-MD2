...
//_antispam.js
const smsNoSpam = () => { return `🤨 No hagas spam, no ppdra usar a The LoliBot-MD por ${60000 / 1000 - 59} Minuto`}

//_antispam_.js
const smsNoSpam2 = () => { return `Fue desbaneado despues de ${60000 / 1000 - 59} Minuto. Por favor no haga spam!!`}
...
const smsAfkM6 = () => { return `*ɴᴏ ᴇsᴘᴇᴄɪғɪᴄᴏ ᴍᴏᴛᴏᴠᴏ ᴅᴇ ɪɴᴀᴄᴛɪᴠɪᴅᴀᴅ (ᴘᴀᴊᴀ)*`} 
