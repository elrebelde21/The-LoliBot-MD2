...
const smsLista11 = () => { return `🏆 𝙏𝙤𝙥 𝙢𝙪𝙣𝙙𝙞𝙖𝙡 🏆`}
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar The LoliBot-MD`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar The LoliBot-MD en Grupos`}
