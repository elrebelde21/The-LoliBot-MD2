...
const smsClearTmp = () => { return `\n╭» 🟢 MULTIMEDIA 🟢\n│☁ ARCHIVOS DE LA CARPETA TMP ELIMINADOS CON EXITOS\n╰―――――――――――――――――――✤`} 
...
//propietario(a.js
const smsPropban1 = (usedPrefix, command, bot) => { return `${lenguajeGB['smsAvisoMG']()}*𝙀𝙩𝙞𝙦𝙪𝙚𝙩𝙚 𝙖 𝙖𝙡𝙜𝙪𝙞𝙚𝙣 𝙥𝙖𝙧𝙖 𝙗𝙖𝙣𝙚𝙖𝙧\n𝙚𝙟𝙚𝙢𝙥𝙡𝙤:*\n*${usedPrefix + command} @${bot}*`}
