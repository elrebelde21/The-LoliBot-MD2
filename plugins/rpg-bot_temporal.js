...
let texto2 = `${ag}¡𝙔𝘼 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀𝙎 𝙏𝙊𝙆𝙀𝙉𝙎! 🪙\n\n𝘾𝙊𝙈𝙋𝙍𝘼 𝙏𝙊𝙆𝙀𝙉𝙎 𝙋𝘼𝙍𝘼 𝙋𝙊𝘿𝙀𝙍 𝙐𝙉𝙄𝙍 𝙏𝙃𝙀 𝙇𝙊𝙇𝙄𝘽𝙊𝙏-𝙈𝘿 𝘼 𝙏𝙐 𝙂𝙍𝙐𝙋𝙊 𝘾𝙊𝙉 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊:\n*${usedPrefix}buy joincount 3*`
...
let texto7 = `${eg}😛 𝙎𝙚 𝙝𝙖 𝙪𝙣𝙞𝙙𝙤 𝙡𝙤𝙡𝙞𝙗𝙤𝙩 𝙘𝙤𝙧𝙧𝙚𝙘𝙩𝙖𝙢𝙚𝙣𝙩𝙚 𝙖𝙡 𝙜𝙧𝙪𝙥𝙤!!!`
...
if (!global.db.data.settings[conn.user.jid].temporal) return conn.sendButton( m.chat, wm, texto0, null, [[`🙌 𝙎𝙊𝙇𝙄𝘾𝙄𝙏𝘼𝙍 𝘾𝙊𝙈𝘼𝙉𝘿𝙊`, `.reporte *Quiero unir a The-LoliBot-MD en mí Grupo. Por favor Active la función #botemporal*`], [`🍀 𝙈 𝙀 𝙉 𝙐`, `.menu`]], fkontak, m) 
...
await conn.sendButton( m.chat, wm, `✅ 𝙎𝙚 𝙝𝙖 𝙪𝙣𝙞𝙙𝙤 𝙖𝙡 𝙜𝙧𝙪𝙥𝙤!!!\n${await conn.getName(res)}\n\n*n𝙍𝙚𝙘𝙪𝙚𝙧𝙙𝙚 𝙦𝙪𝙚 𝙚𝙨 ⏳𝙏𝙚𝙢𝙥𝙤𝙧𝙖𝙡, 𝙪𝙨𝙚 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 ${usedPrefix}menu 𝙋𝙖𝙧𝙖 𝙫𝙚𝙯 𝙚𝙡 𝙢𝙚𝙣𝙪́*\n\n🚪 𝙈𝙚 𝙨𝙖𝙡𝙙𝙧𝙚́ 𝙖𝙪𝙩𝙤𝙢𝙖́𝙩𝙞𝙘𝙖𝙢𝙚𝙣𝙩𝙚 𝙚𝙣:*\n${msToDate(global.db.data.chats[res].expired - now)}\n\n${username} 𝙇𝙚 𝙦𝙪𝙚𝙙𝙖 ${user.joincount} 𝙩𝙤𝙠𝙚𝙣𝙨(S) 🪙*\n\n❕ *𝙋𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙩𝙖𝙢𝙗𝙞𝙚́𝙣 𝙚𝙣 𝙜𝙧𝙪𝙥𝙤 𝙢𝙞𝙚𝙣𝙩𝙧𝙖𝙨 𝙚𝙨𝙩𝙚́ 𝙮𝙤\n\n❕ *𝙎𝙞 𝙦𝙪𝙞𝙚𝙧𝙚 𝙦𝙪𝙚 𝙚𝙨𝙩𝙚 𝙥𝙤𝙧 𝙢𝙖́𝙨 𝙩𝙞𝙚𝙢𝙥𝙤 𝙖𝙪𝙢𝙚𝙣𝙩𝙚 𝙚𝙡 𝙣𝙪𝙣𝙚𝙧𝙤 𝙙𝙚𝙡 𝙩𝙤𝙠𝙚𝙣𝙨 𝙘𝙪𝙖𝙣𝙙𝙤 𝙪𝙨𝙚 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 \n*${usedPrefix + command}*\n\n❗ *𝙀𝙣 𝙘𝙖𝙨𝙤  𝙦𝙪𝙚 𝙪𝙣 𝙖𝙙𝙢𝙞𝙣 𝙢𝙚 𝙚𝙡𝙞𝙢𝙞𝙣𝙚 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤 𝙮 𝙦𝙪𝙞𝙚𝙧𝙖 𝙦𝙪𝙚 𝙫𝙪𝙚𝙡𝙫𝙖,  𝙟𝙤́𝙙𝙚𝙩𝙚 𝙣𝙤 𝙨𝙚 𝙫𝙖𝙣 𝙥𝙤𝙙𝙚𝙧*`, null, [[`+30 𝙈𝙄𝙉𝙐𝙏𝙊𝙎 𝙀𝙉 𝙂𝙍𝙐𝙋𝙊`, `${usedPrefix + command} ${args[0]} 3`], [`🍀 𝙈 𝙀 𝙉 𝙐`, `.menu`]], fkontak, m)
//await conn.sendButton( m.chat, botdate, `${igfg} 𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙏𝙃𝙀 𝙇𝙊𝙇𝙄𝘽𝙊𝙏-𝙈𝘿!!! 😸\n\n💖 𝙂𝘼𝙏𝘼𝘽𝙊𝙏 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n*${username}*`, gata.getRandom(), [[`🍀 𝙈𝙀𝙉𝙐 𝘾𝙊𝙈𝙋𝙇𝙀𝙏𝙊`, `.allmenu`]], fkontak, m)
...
if (user.joincount === 0 ) throw `${ag}*¡YA NO TIENES TOKENS! 🪙*\n\n*COMPRA TOKENS PARA PODER INVITAR Al EL BOT A TÚ GRUPO CON EL COMANDO *${usedPrefix}buy joincount 3 o ${usedPrefix}buy Para ver la Tienda*`
 if (!args[1]) throw `${mg}*USE EL COMANDO COMO ESTE EJEMPLO*\n*${usedPrefix + command} enlace y Número de Token(s)*\n\n*EJEMPLO*\n*${usedPrefix + command} ${nn} 3*\n\n*3 TOKEN 🪙 = 30 MINUTOS*`
if (!linkRegex.test(args[0])) throw `${fg}𝙀𝙉𝙇𝘼𝘾𝙀 𝙉𝙊 𝙑𝘼𝙇𝙄𝘿𝙊.` //Aquí 
...
} conn.sendButton(m.chat, '', wm, null, [['Creador', `/creador`], ['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪 ☘️', '/menu']], m, res) })}
} catch (e) {
