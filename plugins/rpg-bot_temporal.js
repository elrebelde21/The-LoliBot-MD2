...
if (user.joincount < 1) throw `${ag}*¡YA NO TIENES TOKENS! 🪙*\n\n*COMPRA TOKENS PARA PODER INVITAR A LOLIBOT A TÚ GRUPO CON EL COMANDO ${usedPrefix}buy3* *cantidad*`
...
conn.reply(m.chat, `${eg}✅ *SE HA UNIDO LOLIBOT AL GRUPO!!!*`, m).then(async() => { 
...
await conn.reply(m.chat, `${wm} *ES UN BOT DE WHATSAPP QUE TE AYUDARÁ A REALIZAR DIFERENTES ACTIVIDADES 🪄 AL PRIVADO O GRUPO Y TAMBIÉN TE VAS A DIVERTIR 🎈 CON SUS MULTIPLES FUNCIONES, DISFRUTA DE LOLIBOT!!! 😸*\n\n💖 *LOLIBOT FUE INVITADA POR:*\n${username}`, m)
