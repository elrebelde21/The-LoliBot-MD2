...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  let fakemek = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "51995386439-1616969743@g.us","inviteCode": "m","groupName": "P", "caption": 'The LoliBot-MD', 'jpegThumbnail': null}}}
   if (chat.antiTraba && m.text.length > 4500) { //Cantidad máxima de caracteres aceptados en un mensaje//
    ...
    await conn.reply(m.chat, `*[ ! ] Se detecto un mensaje que contiene muchos caracteres [ ! ]*\n`, `${isBotAdmin ? '' : 'No soy administrador, no puedo hacer nada :/'}`, null, { mentions: [m.sender] } )
        if (isBotAdmin) {
