...
conn.sendButton(m.chat, `_🥵 aqui tiene mi Pack 😏_`, author, url, [['🥵 𝑺𝒊𝒈𝒖𝒊𝒆𝒏𝒕𝒆🥵', `${usedPrefix + command}`]], m)
break
case "pack2":  
let url2 = await packgirl[Math.floor(Math.random() * packgirl.length)]
conn.sendButton(m.chat, `_🥵 toma mi pack 😏_`, author, url2, [['🥵 𝑺𝒊𝒈𝒖𝒊𝒆𝒏𝒕𝒆🥵', `${usedPrefix + command}`]], m) 
break
case "pack3":
let url3 = await packmen[Math.floor(Math.random() * packmen.length)]
conn.sendButton(m.chat, `_🥵 aqui tiene mi Pack 😏_`, author, url3, [['🥵 𝑺𝒊𝒈𝒖𝒊𝒆𝒏𝒕𝒆🥵', `${usedPrefix + command}`]], m) 
break
