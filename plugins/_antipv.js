...
if (m.text.includes('PIEDRA') || m.text.includes('PAPEL') || m.text.includes('TIJERA') || m.text.includes('bots') || m.text.includes('deletesesion') || m.text.includes('deletebot') || m.text.includes('serbot') || m.text.includes('jadibot')) return !0
