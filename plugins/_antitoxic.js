...
user.warn += 1
 if (!(user.warn >= 4)) await m.reply(`${user.warn == 1 ? `Hola *@${m.sender.split`@`[0]}*` : `*@${m.sender.split`@`[0]}*`},  ${lenguajeGB['smsToxic1']()} (${isToxic}) ${lenguajeGB['smsToxic2']()}* *${user.warn}/4* advertencia`, false, { mentions: [m.sender] })
    }
